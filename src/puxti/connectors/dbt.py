...
# Shared with other SQL-patching connectors; kept under the old private name
# because existing callers and tests import it from here.
_rename_column_in_sql = rename_column_in_sql
